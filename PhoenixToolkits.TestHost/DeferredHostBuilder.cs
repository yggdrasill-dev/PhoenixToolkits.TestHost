...
internal sealed class DeferredHostBuilder : IHostBuilder
{
	...
	public IHost Build()
	{
		...
		var host = (IHost)_hostFactory!([.. args]);
	...
	private sealed class DeferredHost(IHost host, TaskCompletionSource hostStartedTcs) : IHost, IAsyncDisposable
	{
		...
		public async Task StartAsync(CancellationToken cancellationToken = default)
		{
			...
			using var reg = cancellationToken.UnsafeRegister(_ => hostStartedTcs.TrySetCanceled(), null);
			...
			using var reg2 = host.Services.GetRequiredService<IHostApplicationLifetime>().ApplicationStarted.UnsafeRegister(_ => hostStartedTcs.TrySetResult(), null);
